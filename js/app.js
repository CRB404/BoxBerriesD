(function($) {
  ...
  var emailCapture = firebase.database().ref('emails/strawberriesFour');
  var locationRecord = firebase.database().ref('location/strawberriesFour');
...
// _____________________________________________________________________________
  ...
  window.onload = function() {
    firebase.database().ref('location/strawberriesFour/val').once('value').then(function(snapshot) {
